...
## hevig menstrueel bloedverlies bij VWD
- gebruik scorekaart, check Hb en ijzer, doe MDO
- verwijzing gynaecologie:
	- HMB bij vrouw > 45 jaar
	- intermenstrueel bloedverlies
	- contactbloedingen
	- falen eerstelijnsbehandeling
- adviseer hormonale behandeling of TXA bij vrouwen met VWD en HMB zonder actieve kinderwens
	- combinatiepreparaat, progestageen only of levonorgestrel-bevattend IUD
## antitrombotica bij VWD
### ACS
- conform cardiologie richtlijn, suppletie rondom interventie
- doe MDO  met VWD-behandelaar en cardioloog
	- beperk antitrombotica waar mogelijk
#### secundaire preventie coronaire events
- TAR conform richtlijn
- DAPT en FVIII < 20IE/dL of ernstig fenotype: suppleren
- (PM na iCVA geen DDAVP meer)
### VTE
#### preventie
- tromboseprofylaxe waar geïndiceerd, m.n. postoperatief
	- overweeg mechanische profylaxe als ++ bloedingsrisico
- vermijd FVIII en/of VWF > 150 IE/dL
#### behandeling
- conform landelijke richtlijn
...
- zie ook tabel 10.1, op pagina 115
## datum laatste update
24-02-2024
___
# hemostase update 2023
**bron**: cursus Hemostase update 2023
...
- type 3: geen eiwitsynthe (0 allel van beide genen)
	- vaak gewrichtsbloedingen want FVIII verlaagd
## diagnose
...
- FVIII:C
### second level tests t.b.v. type bepaling
- RIPA:
	- activeert VW in testtube: 
